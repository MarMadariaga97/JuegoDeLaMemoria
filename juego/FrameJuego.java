...
public class FrameJuego {
	...
	public FrameJuego(Tablero t) {
		...
		panelTurnos.setBounds(30, 381, 472, 111);
		...
		for(Map.Entry<JButton, Point> carta : cartas.entrySet()) {
			...
			b.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					inhabilitarCarta(b, t, carta.getValue());
					...
					if (esPrimerCarta) {
						...
						tiempo(parElegido.get(0), parElegido.get(1), t, nombreTurno,  () -> cambioTurno(nombreTurno, cantAciertosJ1, cantAciertosJ2));
...
//--------------------------------------------------------------------------------------	
		...
		timer = new Timer(1000, new ActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
				if (!verificarPar(b1, b2)) {
					...
					inhabilitarCarta(b2, t, cartas.get(b2));
	...
	public void inhabilitarCartasNoSeleccionadas(JButton b1, JButton b2, Tablero t) { //(Point p, b1, //b2)
					 if(!this.aciertos.containsKey(b1) && !this.aciertos.containsKey(b2)){
					 	inhabilitarCarta(b1, t, cartas.get(b1));
					 	inhabilitarCarta(b2, t, cartas.get(b2));
					 }
					
				}

	public void habilitarCartasEnJuego(JButton b1, JButton b2){//(JButton b, Point p) {
	  ...
	  public void inhabilitarCarta(JButton b, Tablero t, Point p) {
		b.setEnabled(false);
